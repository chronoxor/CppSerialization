...
#ifndef FLATBUFFERS_GENERATED_DOMAIN_MYDOMAIN_FLATBUF_H_
#define FLATBUFFERS_GENERATED_DOMAIN_MYDOMAIN_FLATBUF_H_
...
inline flatbuffers::Offset<Balance> CreateBalanceDirect(
    ...
    double Amount = 0.0) {
  return MyDomain::flatbuf::CreateBalance(
      _fbb,
...
inline const MyDomain::flatbuf::Account *GetAccount(const void *buf) {
  return flatbuffers::GetRoot<MyDomain::flatbuf::Account>(buf);
}

inline const MyDomain::flatbuf::Account *GetSizePrefixedAccount(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<MyDomain::flatbuf::Account>(buf);
}

inline bool VerifyAccountBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MyDomain::flatbuf::Account>(nullptr);
}

inline bool VerifySizePrefixedAccountBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MyDomain::flatbuf::Account>(nullptr);
}

inline void FinishAccountBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<MyDomain::flatbuf::Account> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_DOMAIN_MYDOMAIN_FLATBUF_H_
