...
template <class TBuffer>
class FinalModel<TBuffer, ::trade::OrderSide> : public FinalModelBase<TBuffer, ::trade::OrderSide, uint8_t>
{
public:
    using FinalModelBase<TBuffer, ::trade::OrderSide, uint8_t>::FinalModelBase;
};
...
template <class TBuffer>
class FinalModel<TBuffer, ::trade::OrderType> : public FinalModelBase<TBuffer, ::trade::OrderType, uint8_t>
{
public:
    using FinalModelBase<TBuffer, ::trade::OrderType, uint8_t>::FinalModelBase;
};
...
template <class TBuffer>
class FinalModel<TBuffer, ::trade::Order>
{
public:
...
public:
    ...
    FinalModel<TBuffer, ::trade::OrderSide> side;
    FinalModel<TBuffer, ::trade::OrderType> type;
...
public:
    ...
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FinalModel<TBuffer, ::trade::Order>::fbe_type(); }
...
private:
    FinalModel<TBuffer, ::trade::Order> _model;
};
...
template <class TBuffer>
class FinalModel<TBuffer, ::trade::Balance>
{
public:
    FinalModel(TBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
        , currency(buffer, 0)
...
public:
    ...
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FinalModel<TBuffer, ::trade::Balance>::fbe_type(); }
...
private:
    FinalModel<TBuffer, ::trade::Balance> _model;
};
...
template <class TBuffer>
class FinalModel<TBuffer, ::trade::Account>
{
public:
    FinalModel(TBuffer& buffer, size_t offset) noexcept : _buffer(buffer), _offset(offset)
        , id(buffer, 0)
...
public:
    ...
    FinalModel<TBuffer, ::trade::Balance> wallet;
    FinalModelVector<TBuffer, ::trade::Order> orders;
};
...
public:
    ...
    // Get the model type
    static constexpr size_t fbe_type() noexcept { return FinalModel<TBuffer, ::trade::Account>::fbe_type(); }
...
private:
    FinalModel<TBuffer, ::trade::Account> _model;
};
