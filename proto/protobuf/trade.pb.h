...
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern BalanceGlobalsTypeInternal Balance_globals_;
extern const ::google::protobuf::internal::ClassDataFull Balance_class_data_;
#else
extern const BalanceGlobalsTypeInternal Balance_globals_;
#endif  // PROTOBUF_MESSAGE_GLOBALS
class Order;
...
/* @@protoc_insertion_point(class_definition:Trade.protobuf.Balance) */ {
 public:
  ...
  inline Balance(Balance&& from) noexcept : Balance(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const Balance& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<Balance>(&Balance_globals_);
  }
...
/* @@protoc_insertion_point(class_definition:Trade.protobuf.Account) */ {
 ...
 public:
  ...
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::Trade::protobuf::Order>&
  orders() const;
...
inline const ::Trade::protobuf::Balance& Account::_internal_wallet() const {
  ...
  return p != nullptr ? *p : *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<::Trade::protobuf::Balance>(&::Trade::protobuf::Balance_globals_);
}
...
Account::mutable_orders() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
