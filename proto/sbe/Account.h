...
public:
    ...
    Account(char *buffer, const std::uint64_t bufferLength) :
        Account(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    Account(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        Account(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return *this = Account(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    Account &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    Account &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Account(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
#pragma clang diagnostic pop
    ...
    Account &id(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *walletMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t walletSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }
...
public:
    ...
    #pragma GCC diagnostic pop
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t orderSinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }
